...
/*
This code came from Gareth McCaughan, under the VBA.zlib license.
...
Thank you to Gareth for relicensing this code under the VBA.zlib license for our
benefit!
 ...
 * under the "VBA.zlib/VBA.libpng licence"; you will find the actual
