    ...
    public void onKeyUp(int keyCode){
        if(keyCode == KeyEvent.KEYCODE_BACK){
            SDLActivity.mSingleton.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    SDLActivity.mSingleton.tipsDialog = Utils.showTips(SDLActivity.mSingleton,SDLActivity.mSingleton.getString(R.string.notice),SDLActivity.mSingleton.getString(R.string.tips_exit_game));
                    ...
                    SDLActivity.mSingleton.tipsDialog.setOnButton2Listener(SDLActivity.mSingleton.getString(R.string.tips_exit_game_button2), new OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            SDLActivity.mSingleton.finish();
                        }
                    });
                    SDLActivity.mSingleton.tipsDialog.setOnButton3Listener(SDLActivity.mSingleton.getString(R.string.cancel), new OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            SDLActivity.mSingleton.tipsDialog.dismiss();
                        }
